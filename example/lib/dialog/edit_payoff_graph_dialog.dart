...
Future<ShowPayOffGraphTask?> editPayoffGraphDialog({
  ...
  final quantityController = TextEditingController(text: task.quantity.toString());
  final spotPriceController = TextEditingController(text: task.spotPrice.toString());
  final spotPriceDayDeltaController = TextEditingController(text: task.spotPriceDayDelta.toString());
  final spotPriceDayDeltaPerController = TextEditingController(text: task.spotPriceDayDeltaPer.toString());
                    ...
                    TextButton(
                      onPressed: () {
                        ...
                        final updatedTask = ShowPayOffGraphTask(
                          ...
                          spotPriceDayDelta: double.tryParse(spotPriceDayDeltaController.text) ?? 0,
                          spotPriceDayDeltaPer: double.tryParse(spotPriceDayDeltaPerController.text) ?? 0,
                        );
