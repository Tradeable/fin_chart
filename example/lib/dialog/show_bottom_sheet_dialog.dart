...
Future<ShowBottomSheetTask?> showBottomSheetDialog({
  ...
  final TextEditingController primaryButtonTextController = TextEditingController(
    text: initialTask?.primaryButtonText ?? '',
  );
  final TextEditingController secondaryButtonTextController = TextEditingController(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      final primaryButtonText = primaryButtonTextController.text.trim();
                      final secondaryButtonText = secondaryButtonTextController.text.trim();

                      if (title.isEmpty || description.isEmpty || primaryButtonText.isEmpty) {
                         ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                              content: Text('Please fill in title, description, and primary button text')),
                        );
                        return;
                      }
                      ...
                      Navigator.of(context).pop(
                        ShowBottomSheetTask(
                          ...
                          secondaryButtonText: secondaryButtonText.isNotEmpty ? secondaryButtonText : null,
                        ),
                      );
                    },
